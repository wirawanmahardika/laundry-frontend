import { HandCoins, HandPlatter, UserPen } from "lucide-react";
...
export default function Layout() {
    ...
    return <div className="flex h-screen">
        ...
        <div className="dock dock-lg shrink-0">
