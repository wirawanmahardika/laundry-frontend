...
export default function Login() {
    ...
    return (
        <section className="h-screen bg-[url(/gelembung.png)]">
                        ...
                        <form onSubmit={loginHandler} className="space-y-4 md:space-y-6" action="#">
                            <div>
                                ...
                                <input
                                    ...
                                    name="email"
                                    id="email"
                                    className="bg-sky-50 border border-sky-200 text-sky-900 rounded-lg focus:ring-sky-400 focus:border-sky-400 block w-full p-2.5"
                                    required
                                    autoComplete="off"
                                />
                            </div>
                            ...
                            <button
                                type="submit"
                                className="w-full text-white bg-sky-600 hover:bg-sky-700 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition"
                            >
                                Sign in
                            </button>
                        </form>
